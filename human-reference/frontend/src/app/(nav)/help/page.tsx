...
export default function HelpPage() {
	return (
		<div>
			...
			<p>This page explains some core features and UI elements of DART.</p>

			<h2 className="my-4 text-2xl">Colors</h2>

			<p>
				A core element in the UI is inspired by official Formula 1 graphics, the color-coding system used for lap times, sector times,
			...
			<Note className="mb-4">
				Sometimes the tire type is unknown. This can happen at the beginning of a session or when something maybe possibly go wrong.
			</Note>
